...
def add_camera_args(parser):
    ...
    camera_options.add_argument(
        ...
        help="Camera orientation. Use 'portrait' to rotate camera feed 90° clockwise",
        default="landscape",
    )
...
def add_scanner_args(parser) -> None:
    ...
    scanner_options.add_argument(
        "--num_views",
        type=int,
        help="Number of views to capture. System will calculate rotation angle (360°/N) and guide you through rotations",
        default=None,
    )
